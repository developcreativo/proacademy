<div class="container-fluid">
    <div class="row slider-container">
            ...
            <div class="parts-slider" style="background-size: 100%;height: 390px;background-repeat: no-repeat;background-image:url('{{ get_option('main_page_slide','/assets/default/images/view/sample/slider-sample.png') }}');">
